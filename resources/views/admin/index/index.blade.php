            ...
            <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                    <span class="tpl-header-list-user-nick">禁言小张</span><span class="tpl-header-list-user-ico"> <img
                                src="{{asset('assets/img/user01.png')}}"></span>
                </a>
                ...
                <div class="tpl-portlet">
                    ...
                    <div class="tpl-scrollable">
                        ...
                        <table class="am-table tpl-table">
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset('assets/img/user03.png')}}" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset('assets/img/user04.png')}}" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset('assets/img/user05.png')}}" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset('assets/img/user06.png')}}" alt="" class="user-pic">
